...
在Magent2环境中测试MATRPO自博弈算法。

使用方法:
    python examples/test_matrpo_selfplay.py --num_updates 100
"""
...
if __name__ == "__main__":
    ...
    import argparse
    parser = argparse.ArgumentParser(description="MATRPO自博弈训练测试")
    ...
    success = test_algorithm("matrpo", config, args.num_updates)
