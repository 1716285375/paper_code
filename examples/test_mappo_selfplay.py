...
在Magent2环境中测试MAPPO自博弈算法。

使用方法:
    python examples/test_mappo_selfplay.py --num_updates 100
"""
...
if __name__ == "__main__":
    ...
    import argparse
    parser = argparse.ArgumentParser(description="MAPPO自博弈训练测试")
    ...
    success = test_algorithm("mappo", config, args.num_updates)
